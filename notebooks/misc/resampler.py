...
class AbstractInstruction(abc.ABC):
    @property
    @abc.abstractmethod
    def instruction(self) -> ReSampleInstruction:
        ...
...
class ReSampleInstruction(Iterable[ResampleInstruction], AbstractInstruction):
...
class ReSampler(AbstractInstruction):
    def __init__(
        self,
        instruction: ReSampleInstruction,
        /,
        *,
        height: int = 80,
        width: int = 80,
        ...
        self.ReSampleInstruction = instruction
        self.height = height
        self.width = width
    ...
    @property
    def instruction(self) -> ReSampleInstruction:
        return self.ReSampleInstruction
    ...
    def _resample_point_over_time(
        ...
        return [
            ...
            for ds, area_extent in self.ReSampleInstruction
        ]
